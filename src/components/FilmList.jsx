        ...
        <div className="flex flex-wrap relative justify-center items-start">
            {filmList.map(
                (film) => {
                    ...
                    return (
                        <div key={film.id} className="relative flex flex-col p-3 xs:p-5 w-1/2 md:w-1/3 lg:w-1/5">
                            <Link to={`/films/${film.id}`}
                                ...
                                <h2 className="text-clip overflow-hidden h-10 leading-tight  text-white my-2 z-50">{film.original_title}</h2>
                                <RatingFilm
